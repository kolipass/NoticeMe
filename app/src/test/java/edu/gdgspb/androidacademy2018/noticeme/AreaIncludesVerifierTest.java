...
public class AreaIncludesVerifierTest {
    ...
    public void isInArea() {
        AreaIncludesVerifier verifier = new AreaIncludesVerifier(30.333825, 59.974009, 1000);
        //DataArt
    ...
    public void isNotArea() {
        AreaIncludesVerifier verifier = new AreaIncludesVerifier(30.336800, 59.94321, 1000);
        //Шушары
